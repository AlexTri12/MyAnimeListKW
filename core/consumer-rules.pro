...
# Prevent ProGuard from stripping interface information from:
# TypeAdapter, TypeAdapterFactory, JsonSerializer, JsonDeserializer instances (so they can be used in @JsonAdapter)
...
-dontwarn retrofit2.KotlinExtension$.*

# With R8 full mode, it sees no subtypes of Retrofit interfaces since they are created with a Proxy and replaced all potential values with null
